...
<%
	...
	if (null!=user){	//Post from login form
		String pass = request.getParameter("Password");
		if (null==pass) pass = "";
		
		//NOTE: Following lines simulate the login check and session manage of user login
		//It's just an example, you can use JavaBean as UserInfo. ref: org.openxava.util.UserInfo
		Map<String, String> userInfo = new HashMap<String, String>();
		userInfo.put("id", user);
		userInfo.put("givenName", user);
		session.setAttribute("app.userInfo", userInfo);
		
		response.sendRedirect("shell_index.jsp");
	}else{
...
<body>
	<form id="login" action="shell_login.jsp">
		<h1>Log In</h1>
		<fieldset id="inputs">
		...
		<fieldset id="actions">
			...
			<a href="javascript:alert('Not implemented')">Forgot your password?</a>
