<%@page import="org.openxava.ex.jsp.WebResourceRegister"%>
...
<head>
    ...
    <script type="text/javascript" src="<%=contextPath%>/xava-ex/libs/jquery/jquery-1.10.2.js"></script>
    <script type="text/javascript" src="<%=contextPath%>/xava-ex/libs/jquery/jquery-migrate-1.2.1.js"></script>
    <link href="<%=contextPath%>/xava-ex/libs/jquery-ui/jquery-ui-1.10.3/themes/base/jquery-ui.css" rel="stylesheet" />
    <script type="text/javascript" src="<%=contextPath%>/xava-ex/libs/jquery-ui/jquery-ui-1.10.3/ui/jquery-ui.js"></script>
